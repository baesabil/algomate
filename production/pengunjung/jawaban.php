...
<html lang="en">
  ...
  footer {
    background-color: #f2f2f2; /* Warna abu-abu muda */
        ...
        /* Gaya untuk kotak berwarna ungu muda dengan sudut melengkung */
        .box {
        ...
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-md-10 col-lg-8 col-xl-7">
                <div class="site-heading"><br><br><br>
                    ...
                    <span class="subheading"><b>Penjelasan Jawaban</b></span><br><br>
                    <br>
                    <?php
            ...
            <div class="col-md-2 col-lg-4 col-xl-5">
                <!-- Add your image here -->
                <img src="https://img.freepik.com/free-vector/online-job-interview_23-2148642738.jpg?size=626&ext=jpg" width="400" height="420" alt="Foto Pembelajaran">
            </div>
        </div>
    </div>
</header>
...
<!-- exam.php -->
<article class="artikel" style="margin: 100px 100px 100px 100px; text-align: justify;">
        <form method="post">
            <?php
            // Simpan data koneksi ke database pada variabel $conn
            // ...
            ...
            if (isset($_GET['id_materi']) && isset($_GET['username_pengunjung'])) {
                ...
                if (mysqli_num_rows($result_pengunjung) > 0) {
                    // Query untuk mengambil pertanyaan dan penjelasan dari tabel "soal" berdasarkan "id_materi" yang diberikan
                    $query = "SELECT id_soal, pertanyaan, penjelasan FROM soal WHERE id_materi = $id_materi";
                    $result = mysqli_query($conn, $query);

                    // Periksa apakah ada baris yang dikembalikan
                    if (mysqli_num_rows($result) > 0) {
                        // Loop melalui setiap baris dan tampilkan pertanyaan serta penjelasan
                        while ($row = mysqli_fetch_assoc($result)) {
                            $id_soal = $row['id_soal'];
                            $pertanyaan = $row['pertanyaan'];
                            $penjelasan = $row['penjelasan'];

                            // Tampilkan pertanyaan dan penjelasan
                            echo '<div class = box>';
                            echo '<div class="soal">Soal: '. $pertanyaan . '</div>';
                            echo '<div><b>Penjelasan :</b> ' . $penjelasan . '</div>';
                            echo '<br>';
                            echo '</div>';
                        }
                        ...
                        // Perbaikan 2: Tambahkan tombol kembali ke materi
                        echo "<a href='materi.php' class='btn btn-primary'>Kembali Ke Materi</a>";
                    } else {
                        echo "Tidak ada soal yang ditemukan.";
                    }
                } else {
