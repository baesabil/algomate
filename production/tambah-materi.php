                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form class="form-horizontal form-label-left" method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="id_materi">Id materi<span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="id_materi" name="id_materi" required="required" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="telephone">Link <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="url" id="link" name="link" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        // Gunakan prepared statement untuk menghindari injeksi SQL
                                        $query = "INSERT INTO materi (id_materi, id_kategori_materi, judul, deskripsi, link) VALUES ('$id_materi', '$kategori', '$judul', '$deskripsi', '$link')";
                                        ...
                                        echo "<br><a href='materi.php'><< Kembali ke halaman materi</a>";
                                    }
                                    ?>
                                </div>
                            </div>
